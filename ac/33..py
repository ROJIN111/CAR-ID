...
#     en1.pack()
#
#     en2 = Entry(root, textvariable=var1)  # 将变量与文本绑定在一起
#     en2.pack()
#
#     en3 = Entry(root, textvariable=var2)  # 将变量与文本绑定在一起
#     en3.pack()
#
#     en4 = Entry(root, textvariable=var3)  # 将变量与文本绑定在一起
#     en4.pack()
#
#     but_set = Button(root, text="发送", command=a)  # command参数来调用函数
...
def click_button3():
    ...
    def b():
        ...
        but_set = Button(root, text="确定", command=fasong)  # command参数来调用函数
        but_set.pack(pady=10)
        but_set.place(x=150, y=450)
        root.mainloop()

    but_set = Button(win, text="确定", command=b)  # command参数来调用函数
    but_set.pack(pady=10)
    but_set.place(x=50, y=450)
