...
#获取训练集
dataset = torchvision.datasets.CIFAR10(root=r"D:\pythonProject\STUDY\bishe\shujuji\train",train=True,transform=trans,download=True)
dataset2 = torchvision.datasets.CIFAR10(root=r"D:\pythonProject\STUDY\bishe\shujuji\test",train=False,transform=trans,download=True)
